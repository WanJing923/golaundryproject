"""
Django settings for golaundry project.
...
SECRET_KEY = 'django-insecure-i4rqrex@@1l&a%k#e9y^2o%+6d@97^0d6tb#w&05phr6p-mhz&'
...
AUTH_USER_MODEL = 'websiteapp.CustomUser'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'golaundryapp.official@gmail.com'
EMAIL_HOST_PASSWORD = 'opwo vnba iglb jjgr'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'websiteapp/static')
]
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        #Lau Wan Jing: https://www.youtube.com/watch?v=OTmQOjsl0eg&ab_channel=Telusko --direct to the templates file
